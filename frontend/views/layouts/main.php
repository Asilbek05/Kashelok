...
<?php $this->beginBody() ?>
  ...
  <body>
          ...
          <div class="search-field d-none d-md-block">
            <form class="d-flex align-items-center h-100" action="#">
              <div class="input-group">
                ...
                <input type="text" class="form-control bg-transparent border-0" placeholder="Qidirish">
              </div>
            </form>
          </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="  <?= \yii\helpers\Url::to(['/']) ?>">
                <span class="menu-title">Bosh menyu</span>
                <i class="mdi mdi-home menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href=" <?= \yii\helpers\Url::to(['/category']) ?>">
                <span class="menu-title">Kategoriyalar</span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="<?= \yii\helpers\Url::to(['/input']) ?>">Kirimlar</a></li>
                  <li class="nav-item"> <a class="nav-link" href="<?= \yii\helpers\Url::to(['/output']) ?>">Chiqimlar</a></li>
                </ul>
              </div>
            </li>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        const cost = [['Oy nomlari', 'Kirim', 'Chiqim']];
        const month = ['Dekabr', 'Yanvar', 'Fevral', 'Mart', 'Aprel', 'May', 'Iyun', 'Iyul', 'Avgust', 'Sentyabr','Oktyabr','Noyabr'];
        <?php 
        for($i=1; $i<=12;$i++){ ?>
          cost.push([month[<?= $i -1 ?>], <?= Input::MonthCost($i-1)[0]['kirim'] + 0 ?>  , <?= Output::MonthCost($i-1)[0]['chiqim'] + 0 ?>])
        <?php } ?>
        ...
        var options = {
          chart: {
            title: 'Balance',
            subtitle: 'Hozirgi yilning oylar kesimidagi kirim va chiqim grafasi',
          }
        };
